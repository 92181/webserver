...
// gcc main.c -o main -lssl, ./main, https://127.0.0.1:3000/

unsigned int sa,sb,sc,sd,se,*sj,c[10000],i4,*z=c,*i=c+9999,*f=c,*n,*x;int t0;SSL *ssl[10000],*s2,**s0=ssl,**s3,**s4,**s5=ssl;
        ...
        if(y>>31==0)
        {
            ...
            t=a;do // Initial WebSocket handshake;
            {
                if(*t==101)
                {
                    if(*(t+1)==121)
                    {
                        *t=*(t+1)=0;sa=1732584193;sb=4023233417;sc=2562383102;sd=271733878;se=3285377520;t+=28;yt=v,iy=v+36;while(yt<iy){*t=*yt;t+=1;yt+=1;}
